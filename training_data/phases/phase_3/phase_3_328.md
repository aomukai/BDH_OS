...
Draw is a shape on a page.
Draw is a picture of a thing.
...
Draw happens on a wall.
Draw happens on a board.
...
Draw shows a thing.
Draw creates a shape.
Draw records a sight.
...
Draw is for a map.
Draw is for a note.
Draw is for a sketch.
Draw is for a picture and a plan.
