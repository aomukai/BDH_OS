...
function bindSettingsInputs() {
  ...
  $$('[data-visual-field]').forEach((input) => input.addEventListener("change", () => { state.settingsWorking.visual[input.dataset.visualField] = input.dataset.visualField === "shadow_mode" ? input.value === "true" : Number(input.value); }));
