...
## [2026-08-13] design | Ordered Sol planning assignment

- Actor: Codex, under operator direction.
- Added an exact ordered reading procedure and bounded briefing compiler with source
  hashes, context budget, runtime-state requirement, and recorded deep lookups.
- Added one decision schema containing structured question/checklist receipts,
